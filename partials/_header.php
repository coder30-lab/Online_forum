...
<a class="navbar-brand" href="/onlineForum">iDiscuss</a>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav mr-auto">
    <li class="nav-item active">
      <a class="nav-link" href="/onlineForum">Home <span class="sr-only">(current)</span></a>
    </li>
...
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
 echo '<form class="form-inline my-2 my-lg-0" method="get" action= "search.php" >
  ...
  <button type="button" class="btn btn-outline-success mx-2" data-toggle="modal" data-target="#signupModal">Sign Up</button>  </form>';
...
if(isset($_GET['signupsuccess'])&& $_GET['signupsuccess']=="true"){
  ...
  <strong>Sign up successful!</strong> You can login now.
...
if(isset($_GET['error'])&& $_GET['signupsuccess']=="false"){
  ...
  <strong>Sign up Unsuccessful ...!  </strong>' .$error.
  '<button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>';
