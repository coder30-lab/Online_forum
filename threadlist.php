...
<head>
  ...
  <title>Coding-Coding Discussion forum</title>
...
include 'partials/_header.php';
  ...
  <?php
    ...
    if($showalert){
        ...
        <strong>success!</strong> your query is submitted wait for community to answer.
...
?>
  ...
  <!-- form for posting problem -->
  <?php
    //If a user is logged in then can post coment
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
    ...
    echo '<div class="container">
    <p class="py-2">Start a discussion</p>
    <p class="lead text-primary">You are not logged in Please login first</p>
</div>';
    }
    ?>
  ...
  <div class="container mb-5" id="ques">
    ...
    <?php 
            $sql="SELECT * FROM `threads` WHERE thread_cat_id =$id";   //made changes herethread_id to thread_cat_id
            $result=mysqli_query($conn,$sql);
            ...
            <div class="media-body">'.
                ...
                '.$desc.'</div>'.'<p class="font-weight-bold my-0">'.'Asked by '.$user_email.' at '.$timestamp.' </p>'.'</div> ';
            }
            }//closing of while
        ...
        echo '<div  class="jumbotron jumbotron-fluid">
            <div class="container">
                <p class="display-4">No Question Found for this Category</p>
